...
INSERT INTO `venda`(`idcliente`, `idvenda`, `data`, `total`) VALUES (1,32,2022-05-15,[valu)

----------------------------LIVRO terminar---------------------------------
---muda o parameto pdo float para os valores correto
INSERT INTO livro(idgenero, ideditora, idlivro, livro_titulo, livro_preço, livro_estoque) VALUES (1,1,1,"Guerra dos mundos",(1.2),8);
INSERT INTO livro(idgenero, ideditora, idlivro, livro_titulo, livro_preço, livro_estoque) VALUES (3,5,10,"Arquivo x",(1.2),7);
INSERT INTO livro(idgenero, ideditora, idlivro, livro_titulo, livro_preço, livro_estoque) VALUES (4,4,6,"A noite dos mortos vivos",(1.2),3);
INSERT INTO livro(idgenero, ideditora, idlivro, livro_titulo, livro_preço, livro_estoque) VALUES (5,1,52,"E o vento levol",(1.2),4);
INSERT INTO livro(idgenero, ideditora, idlivro, livro_titulo, livro_preço, livro_estoque) VALUES (2,3,15,"como eu era antes de voçe",(1.2),7);
